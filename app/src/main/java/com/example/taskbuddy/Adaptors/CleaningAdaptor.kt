...
import com.example.taskbuddy.SelectServices.CleaningServiceSelect
import com.example.taskbuddy.SelectServices.PlumberServiceSelect

class CleaningAdaptor(private val context: Context, private val data: List<ServiceProviderModal>) :
    RecyclerView.Adapter<CleaningAdaptor.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: ServiceProviderModal) {
            ...
            itemView.setOnClickListener {
                val intent = Intent(context, CleaningServiceSelect::class.java)

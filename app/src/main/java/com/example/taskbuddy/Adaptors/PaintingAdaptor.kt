...
class PaintingAdaptor(private val context: Context, private val data: List<ServiceProviderModal>) :
    RecyclerView.Adapter<PaintingAdaptor.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: ServiceProviderModal) {
            ...
            itemView.setOnClickListener {
                val intent = Intent(context, PaintingServiceSelect::class.java)

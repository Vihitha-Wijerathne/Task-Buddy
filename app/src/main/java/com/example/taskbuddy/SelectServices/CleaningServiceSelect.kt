...
class CleaningServiceSelect : AppCompatActivity() {
    ...
    private var emergencycost: Double = 2500.0
    private var leakcost: Double = 4000.0
    private var pipecost: Double = 1000.0
    private var draincost: Double = 500.0
    private var barthroomcost: Double = 5000.0
    private var kitachencost: Double = 3000.0
    private var totalAmount: Double = 0.0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cleaning_service_select)
        ...
        emergencyrepaires.text = "House Cleaning ( $emergencycost)"
        leakrepaire.text = "Office Cleaning ($leakcost)"
        pipeinstallation.text = "Carpet Cleaning ($pipecost)"
        draincleaning.text = "Window Cleaning ($draincost)"
        barthroomplumbing.text = "Deep Cleaning ($barthroomcost)"
        kitachenplumbing.text = "Garden Cleaning ($kitachencost)"

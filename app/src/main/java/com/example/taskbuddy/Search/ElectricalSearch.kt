...
import com.example.taskbuddy.Adaptors.ElectricalAdaptor
...
class ElectricalSearch : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        electricalAdaptor = ElectricalAdaptor(this, plumberResult)
        plumberRecyclerView.adapter = electricalAdaptor
        ...
        user?.let {
            ...
            dbRef.addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(error: DatabaseError) {
                    ...
                    Toast.makeText(this@ElectricalSearch, "There is a problem retrieving data from the database", Toast.LENGTH_LONG).show()
                }
            })
        }
    }
    ...
    private fun getserviceproviders() {
        ...
        dbRef.orderByChild("service").equalTo("Electrician")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    electricalAdaptor.notifyDataSetChanged()
                }

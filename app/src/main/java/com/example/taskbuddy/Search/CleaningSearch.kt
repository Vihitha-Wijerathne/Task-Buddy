...
import com.example.taskbuddy.Adaptors.CleaningAdaptor
...
class CleaningSearch : AppCompatActivity() {
    ...
    private lateinit var ceaningAdaptor: CleaningAdaptor
    private var ulocation: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cleaning_search)
        ...
        ceaningAdaptor = CleaningAdaptor(this, plumberResult)
        plumberRecyclerView.adapter = ceaningAdaptor
        ...
        user?.let {
            ...
            dbRef.addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(error: DatabaseError) {
                    ...
                    Toast.makeText(this@CleaningSearch, "There is a problem retrieving data from the database", Toast.LENGTH_LONG).show()
                }
            })
        }
    }
    ...
    private fun getserviceproviders() {
        ...
        dbRef.orderByChild("service").equalTo("Cleaner")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    ceaningAdaptor.notifyDataSetChanged()
                }
